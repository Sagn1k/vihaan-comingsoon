...
var app = {
	counter: -1,
	copy: [
		'Hello! <br> Website for Vihan 2017 is under construction. <br>Feel free to contact us at:  <a href="mailto:contact@ieeedtu.com">contact@ieeedtu.com</a>',
		'No! This won\'t help :\'(',
		'Seriously? This is getting awkward now :P',
		'You’ve got to trust me _/\\_'
	]
};
...
$(document).ready(function () {
	...
	if (isMobileOrTablet()) {
		...
		$('#switch, #switch svg').css({
			'left': btnLeftMargin + 'px'
		});
		$('#mobile').attr({
